  ...
  const umkmData = [
    {
      ...
      description:
        'Gudeg dan masakan Jawa tradisional dengan cita rasa autentik dan bumbu rahasia turun temurun.',
      ...
      products: [
        ...
        },
        {
          ...
          price: 12000,
          image:
            'https://images.pexels.com/photos/60616/fried-chicken-chicken-fried-crunchy-60616.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop',
        },
        {
          name: 'Sate Ayam',
          price: 20000,
          image:
            'https://images.pexels.com/photos/8879227/pexels-photo-8879227.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop',
        },
      ],
      featured: true,
    ...
    },
    {
      ...
      category: 'kerajinan',
      image:
        'https://images.pexels.com/photos/416978/pexels-photo-416978.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop',
      description:
        'Kerajinan bambu berkualitas tinggi untuk dekorasi rumah dan keperluan sehari-hari.',
      ...
      products: [
        ...
        },
        {
          ...
          price: 35000,
          image:
            'https://images.pexels.com/photos/1029620/pexels-photo-1029620.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop',
        },
        {
          name: 'Anyaman Dinding',
          price: 75000,
          image:
    ...
    },
    {
      ...
      description:
        'Sayuran organik segar langsung dari kebun sendiri, bebas pestisida dan pupuk kimia.',
      ...
      products: [
        {
          name: 'Paket Sayuran 1kg',
          price: 25000,
          image:
            'https://images.pexels.com/photos/1656663/pexels-photo-1656663.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop',
        },
        {
    ...
    },
    {
      ...
      description:
        'Koleksi hijab dan busana muslim modern dengan bahan berkualitas dan desain terkini.',
      ...
      products: [
        {
          ...
          price: 45000,
          image:
            'https://images.pexels.com/photos/7679720/pexels-photo-7679720.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop',
        },
        {
          name: 'Gamis Katun',
          price: 150000,
          image:
            'https://images.pexels.com/photos/1536619/pexels-photo-1536619.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop',
        },
        {
          name: 'Mukena Traveling',
          price: 85000,
          image:
            'https://images.pexels.com/photos/6069955/pexels-photo-6069955.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop',
        },
      ],
      featured: false,
    ...
    },
    {
      ...
      category: 'kuliner',
      image:
        'https://images.pexels.com/photos/324028/pexels-photo-324028.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop',
      description:
        'Kopi arabica premium dari perkebunan lokal Cilame dengan proses roasting tradisional.',
      ...
      products: [
        {
          name: 'Kopi Bubuk Arabica 250g',
          price: 35000,
          image:
            'https://images.pexels.com/photos/324028/pexels-photo-324028.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop',
        },
        {
          name: 'Kopi Biji Sangrai 500g',
          price: 55000,
          image:
            'https://images.pexels.com/photos/894695/pexels-photo-894695.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop',
        },
        {
    ...
    },
    {
      ...
      category: 'kosmetik',
      image:
        'https://images.pexels.com/photos/7262940/pexels-photo-7262940.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop',
      description:
        'Produk skincare alami dari bahan herbal lokal yang aman untuk semua jenis kulit.',
      ...
      products: [
        {
          name: 'Face Serum Herbal',
          price: 65000,
          image:
            'https://images.pexels.com/photos/7262940/pexels-photo-7262940.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop',
        },
        {
        ...
        {
          name: 'Sabun Madu Propolis',
          price: 25000,
          image:
            'https://images.pexels.com/photos/4465831/pexels-photo-4465831.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop',
        },
      ],
      featured: false,
      ...
      <section className="bg-gradient-to-r from-purple-600 to-pink-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-4">
            Direktori UMKM Desa Cilame
          </h1>
          <p className="text-purple-100 text-lg max-w-2xl mx-auto">
            Temukan dan dukung produk lokal berkualitas dari usaha mikro, kecil,
            dan menengah di Desa Cilame
          </p>
        </div>
      </section>
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 container-responsive">
              {featuredUMKM.map((umkm) => (
                <Card
                  key={umkm.id}
                  className="overflow-hidden hover:shadow-xl transition-shadow border-2 border-yellow-200"
                >
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="mb-4">
                      <p className="text-xs text-gray-500 mb-2">
                        {t('umkm.popular_products')}
                      </p>
                      <div className="flex space-x-2 overflow-x-auto">
                        {umkm.products.slice(0, 3).map((product, index) => (
                          <div
                            key={index}
                            className="flex-shrink-0 w-16 h-16 relative rounded-lg overflow-hidden aspect-square"
                          >
                            <Image
                              src={product.image}
                              alt={product.name}

...
export default function PasarKerjaPage() {
  ...
  const workers = [
    {
      ...
      hourlyRate: '50000',
      description:
        'Berpengalaman 10 tahun dalam konstruksi bangunan, renovasi rumah, dan perbaikan atap.',
    ...
    },
    {
      ...
      hourlyRate: '25000',
      description:
        'Berpengalaman mengurus rumah tangga, memasak, dan merawat anak-anak dengan penuh perhatian.',
    ...
    },
    {
      ...
      hourlyRate: '40000',
      description:
        'Spesialis service motor dan mobil, berpengalaman 8 tahun dengan berbagai merk kendaraan.',
    ...
    },
    {
      ...
      hourlyRate: '75000',
      description:
        'Chef berpengalaman untuk acara khusus, catering, dan masakan rumahan dengan cita rasa istimewa.',
    ...
    },
    {
      ...
      hourlyRate: '30000',
      description:
        'Ahli dalam perawatan taman, pemangkasan pohon, dan berkebun organik.',
    ...
    },
    {
      ...
      hourlyRate: '45000',
      description:
        'Service TV, kulkas, mesin cuci, dan elektronik rumah tangga lainnya dengan garansi.',
  ...
  const filteredWorkers = workers.filter((worker) => {
    ...
    const matchesCategory =
      selectedCategory === 'semua' || worker.category === selectedCategory
    const matchesLocation =
      selectedLocation === 'semua' || worker.location === selectedLocation
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-blue-100 text-lg max-w-2xl mx-auto">
            Temukan jasa dan pekerja terpercaya di Desa Cilame dengan sistem
            booking dan pembayaran yang aman
          </p>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          <p className="text-gray-600">
            {t('job.showing_workers').replace(
              '{count}',
              filteredWorkers.length.toString()
            )}
          </p>
        </div>
              ...
              <CardContent className="p-0">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center text-sm text-gray-600 mb-3">
                    ...
                    <span>
                      {worker.completedJobs} {t('job.completed_jobs')}
                    </span>
                  </div>
        ...
        <div className="bg-blue-600 rounded-lg p-8 mt-12 text-center text-white">
          ...
          <p className="text-blue-100 mb-6">{t('job.join_description')}</p>

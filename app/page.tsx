...
export default function Home() {
  ...
  return (
    <div className="w-full overflow-x-hidden bg-white">
      ...
      {/* Hero Banner */}
      <section className="relative hero-section h-[70vh] min-h-[500px] max-h-[800px] overflow-hidden">
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center text-center text-white">
              <div className="max-w-4xl px-4 w-full">
                {index === 0 ? (
                  <div className="mb-6">
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-4 leading-tight text-white drop-shadow-2xl">
                      <span className="bg-gradient-to-r from-white via-green-100 to-white bg-clip-text text-transparent">
                        Selamat Datang
                      </span>
                    </h1>
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-semibold text-green-300 drop-shadow-xl mb-2">
                      di Desa Cilame
                    </h2>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Link href="/kontak">
                    <Button size="lg" variant="outline" className="bg-white/10 border-white text-white hover:bg-white hover:text-black min-w-[200px]">
